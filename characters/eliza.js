...
function lapis_luxury() {
   ...
   description = 'Красивый скин с высокой атакой и бесполезной абилкой. Максимум, можно снизить своё здоровье до 1% с неупалом, и при активации бб3 поменяться здоровьем с врагом и убить его этой бб3; либо играть чисто уроном без абилки. Но всё же, качать не стоит.';
...
function diva_intervention() {
   ...
   description = 'Отличная для золота и также для алмаза, можно играть и в быстрых играх, и в рифтах, против Пэйнвил с отражением урона и некоторых бафферов. Прокачивать можно, но вариация уже устарела.';
...
function stand_out() {
   ...
   description = 'Одна из лучших Элайз, прокачивать рекомендуется. Разблокировать уникальное умение наоборот не рекомендуется: дорого и бесполезно, лучше ходить без уника и сэкономить ресурсы. Поэтому можно также экономить на древе Элайзы, не докачивая ненужные ветки.';
   ability = 'Когда ваш уровень здоровья ниже чем у противника, 75% наносимого урона (включая блок) восстанавливают здоровье. Когда противник пытается получить положительный эффект, 50% шанс отменить этот эффект и получить 25% к шкале блокбастера.';
   marquee1 = `${eliza.marquee1}`;
   marquee2 = `${eliza.marquee2}`;
   prestige_description = `${eliza.prestige}`;
   prestige_activation = `${eliza.p_active}`;
   ...
   def_stats = ['Атака', 'Здоровье', 'Защита'];
   build_1_img = 'eliza/Weight_Of_Anubis.png';
   build_2_img = 'eliza/Upper_Khat.png';
   build_3_img = 'eliza/Sekhmets_Bite.png';
   build_4_img = 'eliza/Chaos_Banish.png';
