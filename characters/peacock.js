...
function prism_plumage() {
   ...
   person.addition = '<ul>Список эффектов (при призыве; при ударе снарядом):<li> Ветер: регенерация и уклонение; кровотечение</li><li> Огонь: бешенство и 3 точности; увечья</li><li> Вода: броня и автоблок; раскол брони</li><li> Свет: иммунитет и непоколебимость; обратная полярность</li><li> Тьма: шипы и ускорение; иссушение</li><li> Бесстихийные: барьер и миазмы; порча</li></ul>';
   skullgirls.replaceChildren();
   pageGenerator();
   addition();
}
