...
function rainbow_blight() {
   ...
   person.build_4_desc = 'Наложит порчу.';
   person.addition = '<p style="width: 400px" class="box">Список эффектов:</br> Ветер: сильная регенерация и блок блокбастеров</br> Огонь: 2 бешенства и кровотечение</br> Вода: 2 брони и увечье</br> Свет: иммунитет и порча</br> Тьма: ускорение и блок исцеления</p>';
   skullgirls.replaceChildren();
   pageGenerator();
   addition();
   highlight(m1);
